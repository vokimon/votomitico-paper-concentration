...
def draw_seat_price_illustration(svg_filename="critical-zones.svg"):
    ...
    dwg.add(dwg.text("N", insert=(orange_start + red_width / 2, bar_y + 40), text_anchor="middle", font_size="12px"))
    dwg.add(dwg.text(
    ...
    dwg.add(dwg.text("P - N", insert=(green_start + green_width / 2, bar_y + 40), text_anchor="middle", font_size="12px"))
    dwg.add(dwg.text(
